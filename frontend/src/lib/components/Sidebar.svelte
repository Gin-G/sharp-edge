<script lang="ts">
  ...
  const nav = [
    ...
    },
    {
      href: '/nfl',
      label: 'NFL',
      icon: `<path stroke-linecap="round" stroke-linejoin="round" d="M3.75 12c0-4.556 3.694-8.25 8.25-8.25s8.25 3.694 8.25 8.25-3.694 8.25-8.25 8.25S3.75 16.556 3.75 12zM9 9l6 6m0-6l-6 6"/><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 7.5c4.5 1.5 10.5 1.5 15 0M4.5 16.5c4.5-1.5 10.5-1.5 15 0"/>`,
    },
    {
      href: '/chat',
      label: 'Chat',
...
<nav class="flex flex-col h-full w-64 md:w-56 bg-surface-800 border-r border-border flex-shrink-0">
  ...
  <div class="px-5 py-5 border-b border-border">
    <div class="flex items-center gap-2.5">
      ...
      <span class="font-semibold text-white tracking-tight">Sharp Edge</span>
    </div>
  </div>
